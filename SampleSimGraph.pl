...
# DOES NOT SEEM LIKE IT WILL WORK FOR THIS DATA SINCE IT IGNORES LABELS, and I don't think that yields good linguistic results
...
#$g2->add_vertices("1","2","3","4","5");
#$g2->add_edges(["1","2"],["1","3"],["2","3"],["2","5"],["3","4"],["3","5"],["4","2"]);

#$g2->add_vertices("truthy","verisimilar","giving","belief","probably","likely");
#$g2->add_edges( ["truthy", "probable"], ["verisimilar", "probable"], ["probable", "likely"], ["probable", "giving"], ["likely", "belief"], ["probably", "probable"]);
