...
rdfTemplates.load("/Volumes/Obang/MyDocuments/Linearity/template_ontology/template.rdf")
...
outfile = "/Volumes/Obang/MyDocuments/Linearity/template_ontology/template.nex"
