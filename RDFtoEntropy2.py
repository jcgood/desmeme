...
outfile = open("EntropyTables2.txt", "w")
...
rfile = open("EntropyCalcs2.r", "w")

print >> rfile, "library(vcd)"
print >> rfile, "library(entropy)"
print >> rfile, "library(parmigene)"
print >> rfile, ""
print >> rfile,  "templates = read.csv(\'/Users/jcgood/gitrepos/desmeme/EntropyTables2.txt\', header=TRUE, row.names=1)"
print >> rfile,  ""
