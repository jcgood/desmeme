...
$BantuCT->add_edge_by_id("component1", "unstable1", "STABILITY");
...
$BantuCT->add_edge_by_id("component2", "stable1", "STABILITY");
...
$BantuCT->add_edge_by_id("unstable1", "component2", "ASSOCIATE");
$BantuCT->add_edge_by_id("inelastic1", "COUNT1-1", "COUNT");
$BantuCT->add_edge_by_id("inelastic2", "COUNT0-1", "COUNT");
$BantuCT->add_edge_by_id("arch", "component1", "RIGHT_VOUSSOIR");
$BantuCT->add_edge_by_id("arch", "component2", "RIGHT_SUPPORT");
...
$NimboranVerb->add_edge_by_id("span", "component2", "LEFT_SUPPORT");
...
$NimboranVerb->add_edge_by_id("component5", "filled1", "FILLEDNESS");
$NimboranVerb->add_edge_by_id("component5", "elastic3", "ELASTICITY");
$NimboranVerb->add_edge_by_id("component4", "open4", "FILLEDNESS");
...
$NimboranVerb->add_edge_by_id("component7", "filled3", "FILLEDNESS");
$NimboranVerb->add_edge_by_id("component6", "elastic4", "ELASTICITY");
$NimboranVerb->add_edge_by_id("component6", "filled2", "FILLEDNESS");
...
$NimboranVerb->add_edge_by_id("component3", "open3", "FILLEDNESS");
...
$NimboranVerb->add_edge_by_id("open2", "incoherent1", "COHERENCE");
...
$ChichewaAR->add_edge_by_id("component1", "null1", "FILLEDNESS");
...
$ChichewaAR->add_edge_by_id("component2", "open1", "FILLEDNESS");
...
$ChichewaAR->add_edge_by_id("arch", "component1", "LEFT_VOUSSOIR");
$ChichewaAR->add_edge_by_id("arch", "component2", "LEFT_SUPPORT");
...
$MandeClause->add_edge_by_id("elastic2", "MAXIMUM100-1", "MAXIMUM");
...
$MandeClause->add_edge_by_id("component4", "elastic2", "ELASTICITY");
...
$MandeClause->add_edge_by_id("component3", "inelastic2", "ELASTICITY");
$MandeClause->add_edge_by_id("component2", "open2", "FILLEDNESS");
$MandeClause->add_edge_by_id("component2", "inelastic1", "ELASTICITY");
...
$MandeClause->add_edge_by_id("arch", "component2", "KEYSTONE");
$MandeClause->add_edge_by_id("arch", "component3", "LEFT_SUPPORT");
$MandeClause->add_edge_by_id("arch", "component4", "RIGHT_VOUSSOIR");
$MandeClause->add_edge_by_id("arch", "component5", "LEFT_VOUSSOIR");
$MandeClause->add_edge_by_id("arch", "component4", "RIGHT_VOUSSOIR");
$MandeClause->add_edge_by_id("restkomponentenSet", "component1", "RESTKOMPONENT");
...
$NdebeleCA->add_edge_by_id("arch", "component3", "LEFT_SUPPORT");
$NdebeleCA->add_edge_by_id("arch", "component4", "RIGHT_SUPPORT");
...
$EnglishVP->add_edge_by_id("component3", "null1", "FILLEDNESS");
...
$EnglishVP->add_edge_by_id("arch", "component3", "LEFT_VOUSSOIR");
$EnglishVP->add_edge_by_id("arch", "component3", "LEFT_VOUSSOIR");
...
$MeskwakiClause->add_edge_by_id("component3", "unstable1", "STABILITY");
...
$MeskwakiClause->add_edge_by_id("arch", "component1", "RIGHT_SUPPORT");
$MeskwakiClause->add_edge_by_id("arch", "component3", "LEFT_SUPPORT");
...
$AghemClause->add_edge_by_id("component4", "open3", "FILLEDNESS");
...
$AghemClause->add_edge_by_id("component3", "inelastic2", "ELASTICITY");
$AghemClause->add_edge_by_id("component3", "unstable1", "STABILITY");
$AghemClause->add_edge_by_id("component3", "open4", "FILLEDNESS");
...
$AghemClause->add_edge_by_id("unstable1", "component4", "ASSOCIATE");
...
$AghemClause->add_edge_by_id("arch", "component2", "RIGHT_SUPPORT");
$AghemClause->add_edge_by_id("arch", "component3", "RIGHT_VOUSSOIR");
$AghemClause->add_edge_by_id("arch", "component5", "KEYSTONE");
$AghemClause->add_edge_by_id("arch", "component6", "LEFT_VOUSSOIR");
$AghemClause->add_edge_by_id("arch", "restkomponentenSet", "RESTKOMPONENTEN");
$AghemClause->add_edge_by_id("open6", "coherent6", "COHERENCE");
$AghemClause->add_edge_by_id("restkomponentenSet", "component4", "RESTKOMPONENT");
...
$BantuCA->add_edge_by_id("component4", "open1", "FILLEDNESS");
...
$BantuCA->add_edge_by_id("component3", "null1", "FILLEDNESS");
...
$BantuCA->add_edge_by_id("arch", "component1", "RIGHT_VOUSSOIR");
$BantuCA->add_edge_by_id("arch", "component2", "RIGHT_SUPPORT");
$BantuCA->add_edge_by_id("arch", "component3", "LEFT_VOUSSOIR");
$BantuCA->add_edge_by_id("arch", "component4", "KEYSTONE");
$BantuCA->add_edge_by_id("arch", "component4", "KEYSTONE");
...
$GermanClause->add_edge_by_id("unstable1", "left", "ASSOCIATE_POSITION");
...
$GermanClause->add_edge_by_id("arch", "component3", "RIGHT_SUPPORT");
$GermanClause->add_edge_by_id("arch", "component4", "LEFT_SUPPORT");
$GermanClause->add_edge_by_id("arch", "component2", "KEYSTONE");
$GermanClause->add_edge_by_id("arch", "component4", "LEFT_SUPPORT");
$GermanClause->add_edge_by_id("arch", "component5", "RIGHT_VOUSSOIR");
$GermanClause->add_edge_by_id("restkomponentenSet", "component1", "RESTKOMPONENT");
...
$TieneVerbSegments->add_edge_by_id("component1", "open2", "FILLEDNESS");
...
$TieneVerbSegments->add_edge_by_id("component2", "open1", "FILLEDNESS");
...
$TieneVerbSegments->add_edge_by_id("arch", "component3", "LEFT_SUPPORT");
...
$EnglishPlural->add_edge_by_id("arch", "component2", "LEFT_VOUSSOIR");
$EnglishPlural->add_edge_by_id("arch", "component2", "LEFT_VOUSSOIR");
