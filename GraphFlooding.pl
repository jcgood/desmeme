...
$ChichewaAR->add_edge_by_id("component2", "inelastic2", "ELASTICITY");
...
$ChichewaAR->add_edge_by_id("arch", "component3", "RIGHT_VOUSSOIR");
$ChichewaAR->add_edge_by_id("component3", "elastic1", "ELASTICITY");
$ChichewaAR->add_edge_by_id("elastic1", "MINIMUM0-1", "MINIMUM");
$ChichewaAR->add_edge_by_id("elastic1", "MAXIMUM1-1", "MAXIMUM");
$ChichewaAR->add_edge_by_id("component3", "filled1", "FILLEDNESS");
...
$ChichewaAR->add_edge_by_id("arch", "component4", "RIGHT_SUPPORT");
...
$MeskwakiClause->add_edge_by_id("arch", "component1", "LEFT_SUPPORT");
$MeskwakiClause->add_edge_by_id("component1", "elastic1", "ELASTICITY");
$MeskwakiClause->add_edge_by_id("elastic1", "MINIMUM0-1", "MINIMUM");
$MeskwakiClause->add_edge_by_id("elastic1", "MAXIMUM1-1", "MAXIMUM");
$MeskwakiClause->add_edge_by_id("component1", "open1", "FILLEDNESS");
$MeskwakiClause->add_edge_by_id("open1", "coherent1", "COHERENCE");
$MeskwakiClause->add_edge_by_id("component1", "unstable1", "STABILITY");
$MeskwakiClause->add_edge_by_id("unstable1", "right", "ASSOCIATE_POSITION");
$MeskwakiClause->add_edge_by_id("unstable1", "component2", "ASSOCIATE");
$MeskwakiClause->add_edge_by_id("component2", "inelastic1", "ELASTICITY");
...
$MeskwakiClause->add_edge_by_id("component2", "stable1", "STABILITY");
...
$MeskwakiClause->add_edge_by_id("elastic2", "MAXIMUM1-2", "MAXIMUM");
...
$MeskwakiClause->add_edge_by_id("arch", "component5", "RIGHT_VOUSSOIR");
$MeskwakiClause->add_edge_by_id("component5", "elastic4", "ELASTICITY");
$MeskwakiClause->add_edge_by_id("elastic4", "MINIMUM0-4", "MINIMUM");
$MeskwakiClause->add_edge_by_id("elastic4", "MAXIMUM100-1", "MAXIMUM");
...
$MeskwakiClause->add_edge_by_id("arch", "component2", "KEYSTONE");
$MeskwakiClause->add_edge_by_id("arch", "component5", "RIGHT_SUPPORT");
...
$BantuCT->add_edge_by_id("arch", "component1", "LEFT_SUPPORT");
$BantuCT->add_edge_by_id("component1", "inelastic1", "ELASTICITY");
...
$BantuCT->add_edge_by_id("component2", "inelastic2", "ELASTICITY");
...
$BantuCT->add_edge_by_id("arch", "component3", "RIGHT_VOUSSOIR");
$BantuCT->add_edge_by_id("component3", "elastic1", "ELASTICITY");
$BantuCT->add_edge_by_id("elastic1", "MINIMUM0-1", "MINIMUM");
$BantuCT->add_edge_by_id("elastic1", "MAXIMUM1-1", "MAXIMUM");
$BantuCT->add_edge_by_id("component3", "filled1", "FILLEDNESS");
$BantuCT->add_edge_by_id("filled1", "canonicalLineate1", "FORM");
$BantuCT->add_edge_by_id("component3", "unstable1", "STABILITY");
$BantuCT->add_edge_by_id("unstable1", "right", "ASSOCIATE_POSITION");
$BantuCT->add_edge_by_id("unstable1", "component4", "ASSOCIATE");
...
$BantuCT->add_edge_by_id("arch", "component1", "KEYSTONE");
$BantuCT->add_edge_by_id("arch", "component4", "RIGHT_SUPPORT");
...
$NimboranVerb->add_edge_by_id("span", "component2", "RIGHT_SUPPORT");
$NimboranVerb->add_edge_by_id("component2", "inelastic1", "ELASTICITY");
...
$NimboranVerb->add_edge_by_id("component5", "stable5", "STABILITY");
...
$NimboranVerb->add_edge_by_id("component6", "unstable1", "STABILITY");
$NimboranVerb->add_edge_by_id("unstable1", "left", "ASSOCIATE_POSITION");
$NimboranVerb->add_edge_by_id("unstable1", "component7", "ASSOCIATE");
...
$NimboranVerb->add_edge_by_id("restkomponentenSet", "component7", "RESTKOMPONENT");
...
$NdebeleCA->add_edge_by_id("restkomponentenSet", "component2", "RESTKOMPONENT");
$NdebeleCA->add_edge_by_id("component2", "elastic1", "ELASTICITY");
$NdebeleCA->add_edge_by_id("elastic1", "MINIMUM0-1", "MINIMUM");
$NdebeleCA->add_edge_by_id("elastic1", "MAXIMUM100-1", "MAXIMUM");
$NdebeleCA->add_edge_by_id("component2", "open2", "FILLEDNESS");
$NdebeleCA->add_edge_by_id("open2", "coherent2", "COHERENCE");
$NdebeleCA->add_edge_by_id("component2", "stable2", "STABILITY");
$NdebeleCA->add_edge_by_id("arch", "component3", "LEFT_VOUSSOIR");
$NdebeleCA->add_edge_by_id("component3", "inelastic2", "ELASTICITY");
$NdebeleCA->add_edge_by_id("inelastic2", "COUNT0-1", "COUNT");
$NdebeleCA->add_edge_by_id("component3", "null1", "FILLEDNESS");
...
$NdebeleCA->add_edge_by_id("arch", "component1", "KEYSTONE");
...
$AghemClause->add_edge_by_id("arch", "component1", "LEFT_SUPPORT");
...
$AghemClause->add_edge_by_id("restkomponentenSet", "component2", "RESTKOMPONENT");
$AghemClause->add_edge_by_id("component2", "elastic1", "ELASTICITY");
...
$AghemClause->add_edge_by_id("component3", "elastic2", "ELASTICITY");
...
$AghemClause->add_edge_by_id("arch", "component4", "RIGHT_VOUSSOIR");
$AghemClause->add_edge_by_id("component4", "inelastic2", "ELASTICITY");
...
$AghemClause->add_edge_by_id("component4", "unstable1", "STABILITY");
...
$AghemClause->add_edge_by_id("component5", "inelastic3", "ELASTICITY");
...
$AghemClause->add_edge_by_id("arch", "component6", "RIGHT_SUPPORT");
$AghemClause->add_edge_by_id("component6", "elastic3", "ELASTICITY");
...
$ChintangPrefixes->add_edge_by_id("arch", "component3", "RIGHT_VOUSSOIR");
...
$ChintangPrefixes->add_edge_by_id("arch", "component3", "RIGHT_SUPPORT");
...
$EnglishVP->add_edge_by_id("arch", "component4", "RIGHT_SUPPORT");
...
$GermanClause->add_edge_by_id("restkomponentenSet", "component3", "RESTKOMPONENT");
$GermanClause->add_edge_by_id("arch", "component1", "LEFT_VOUSSOIR");
$GermanClause->add_edge_by_id("arch", "component4", "RIGHT_VOUSSOIR");
...
$GermanClause->add_edge_by_id("arch", "component5", "RIGHT_SUPPORT");
...
$BantuVCy->add_edge_by_id("arch", "component1", "LEFT_SUPPORT");
$BantuVCy->add_edge_by_id("component1", "inelastic1", "ELASTICITY");
...
$BantuVCy->add_edge_by_id("component2", "inelastic2", "ELASTICITY");
...
$BantuVCy->add_edge_by_id("component3", "elastic1", "ELASTICITY");
...
$BantuVCy->add_edge_by_id("arch", "component1", "KEYSTONE");
$BantuVCy->add_edge_by_id("arch", "component4", "RIGHT_SUPPORT");
...
$BantuVCy->add_edge_by_id("component4", "filled1", "FILLEDNESS");
...
$BantuVCy->add_edge_by_id("filledComponentSet", "component4", "FILLED_COMPONENT");
...
$EnglishPlural->add_edge_by_id("arch", "component1", "LEFT_SUPPORT");
$EnglishPlural->add_edge_by_id("component1", "inelastic1", "ELASTICITY");
$EnglishPlural->add_edge_by_id("inelastic1", "COUNT0-1", "COUNT");
$EnglishPlural->add_edge_by_id("component1", "null1", "FILLEDNESS");
$EnglishPlural->add_edge_by_id("component1", "stable1", "STABILITY");
$EnglishPlural->add_edge_by_id("arch", "component1", "LEFT_VOUSSOIR");
$EnglishPlural->add_edge_by_id("arch", "component2", "RIGHT_VOUSSOIR");
$EnglishPlural->add_edge_by_id("component2", "inelastic2", "ELASTICITY");
$EnglishPlural->add_edge_by_id("inelastic2", "COUNT1-1", "COUNT");
$EnglishPlural->add_edge_by_id("component2", "filled1", "FILLEDNESS");
...
$EnglishPlural->add_edge_by_id("arch", "component2", "RIGHT_SUPPORT");
...
$EnglishPlural->add_edge_by_id("filledComponentSet", "component2", "FILLED_COMPONENT");
...
$TieneVerbSegments->add_edge_by_id("arch", "component2", "LEFT_VOUSSOIR");
$TieneVerbSegments->add_edge_by_id("component2", "inelastic2", "ELASTICITY");
$TieneVerbSegments->add_edge_by_id("inelastic2", "COUNT0-1", "COUNT");
$TieneVerbSegments->add_edge_by_id("component2", "null1", "FILLEDNESS");
$TieneVerbSegments->add_edge_by_id("component2", "stable2", "STABILITY");
$TieneVerbSegments->add_edge_by_id("arch", "component3", "RIGHT_VOUSSOIR");
...
$TieneVerbSegments->add_edge_by_id("component3", "open2", "FILLEDNESS");
$TieneVerbSegments->add_edge_by_id("open2", "coherent2", "COHERENCE");
$TieneVerbSegments->add_edge_by_id("component3", "unstable1", "STABILITY");
$TieneVerbSegments->add_edge_by_id("unstable1", "right", "ASSOCIATE_POSITION");
$TieneVerbSegments->add_edge_by_id("unstable1", "component4", "ASSOCIATE");
$TieneVerbSegments->add_edge_by_id("component4", "elastic2", "ELASTICITY");
...
$TieneVerbSegments->add_edge_by_id("component4", "unstable2", "STABILITY");
$TieneVerbSegments->add_edge_by_id("unstable2", "left", "ASSOCIATE_POSITION");
$TieneVerbSegments->add_edge_by_id("unstable2", "component3", "ASSOCIATE");
$TieneVerbSegments->add_edge_by_id("arch", "component1", "KEYSTONE");
$TieneVerbSegments->add_edge_by_id("arch", "component4", "RIGHT_SUPPORT");
