...
$AghemClause->add_edge_by_id("elastic3", "MAXIMUM1-1", "MAXIMUM");
$AghemClause->add_edge_by_id("elastic3", "MINIMUM0-3", "MINIMUM");
$AghemClause->add_edge_by_id("elastic2", "MAXIMUM100-2", "MAXIMUM");
...
$AghemClause->add_edge_by_id("arch", "component2", "LEFT_VOUSSOIR");
...
$BantuCA->add_edge_by_id("component3", "inelastic2", "ELASTICITY");
$BantuCA->add_edge_by_id("component2", "null1", "FILLEDNESS");
$BantuCA->add_edge_by_id("component2", "stable2", "STABILITY");
$BantuCA->add_edge_by_id("component2", "inelastic1", "ELASTICITY");
...
$BantuCA->add_edge_by_id("inelastic1", "COUNT0-1", "COUNT");
$BantuCA->add_edge_by_id("inelastic2", "COUNT1-1", "COUNT");
...
$BantuCA->add_edge_by_id("arch", "component3", "KEYSTONE");
$BantuCA->add_edge_by_id("arch", "component4", "RIGHT_VOUSSOIR");
...
$BantuCT->add_edge_by_id("component4", "filled2", "FILLEDNESS");
$BantuCT->add_edge_by_id("component4", "unstable1", "STABILITY");
$BantuCT->add_edge_by_id("component4", "elastic2", "ELASTICITY");
...
$BantuCT->add_edge_by_id("component3", "stable3", "STABILITY");
$BantuCT->add_edge_by_id("component3", "inelastic2", "ELASTICITY");
$BantuCT->add_edge_by_id("component2", "null1", "FILLEDNESS");
$BantuCT->add_edge_by_id("component2", "stable2", "STABILITY");
$BantuCT->add_edge_by_id("component2", "inelastic1", "ELASTICITY");
$BantuCT->add_edge_by_id("filledComponentSet", "component4", "FILLED_COMPONENT");
...
$BantuCT->add_edge_by_id("inelastic1", "COUNT0-1", "COUNT");
$BantuCT->add_edge_by_id("inelastic2", "COUNT1-1", "COUNT");
$BantuCT->add_edge_by_id("arch", "component1", "RIGHT_SUPPORT");
$BantuCT->add_edge_by_id("arch", "component2", "LEFT_VOUSSOIR");
$BantuCT->add_edge_by_id("arch", "component3", "KEYSTONE");
$BantuCT->add_edge_by_id("arch", "component3", "KEYSTONE");
$BantuCT->add_edge_by_id("arch", "component4", "RIGHT_VOUSSOIR");
...
$MeskwakiClause->add_edge_by_id("component4", "inelastic1", "ELASTICITY");
...
$MeskwakiClause->add_edge_by_id("component3", "elastic3", "ELASTICITY");
...
$MeskwakiClause->add_edge_by_id("unstable1", "component4", "ASSOCIATE");
$MeskwakiClause->add_edge_by_id("inelastic1", "COUNT1-1", "COUNT");
$MeskwakiClause->add_edge_by_id("arch", "component1", "RIGHT_VOUSSOIR");
$MeskwakiClause->add_edge_by_id("arch", "component2", "LEFT_VOUSSOIR");
$MeskwakiClause->add_edge_by_id("arch", "restkomponentenSet", "RESTKOMPONENTEN");
$MeskwakiClause->add_edge_by_id("arch", "component4", "KEYSTONE");
$MeskwakiClause->add_edge_by_id("arch", "component5", "LEFT_SUPPORT");
$MeskwakiClause->add_edge_by_id("arch", "component1", "RIGHT_VOUSSOIR");
$MeskwakiClause->add_edge_by_id("restkomponentenSet", "component3", "RESTKOMPONENT");
...
$MandeClause->add_edge_by_id("arch", "component1", "RIGHT_VOUSSOIR");
$MandeClause->add_edge_by_id("restkomponentenSet", "component3", "RESTKOMPONENT");
$MandeClause->add_edge_by_id("open5", "coherent4", "COHERENCE");
$MandeClause->add_edge_by_id("open4", "coherent3", "COHERENCE");
$MandeClause->add_edge_by_id("open1", "incoherent1", "COHERENCE");
...
$MandeClause->add_edge_by_id("open2", "coherent1", "COHERENCE");
...
$EnglishPlural->add_edge_by_id("inelastic2", "COUNT0-1", "COUNT");
$EnglishPlural->add_edge_by_id("inelastic3", "COUNT1-2", "COUNT");
$EnglishPlural->add_edge_by_id("arch", "component1", "RIGHT_VOUSSOIR");
$EnglishPlural->add_edge_by_id("arch", "component2", "LEFT_SUPPORT");
$EnglishPlural->add_edge_by_id("arch", "component3", "KEYSTONE");
$EnglishPlural->add_edge_by_id("arch", "component2", "LEFT_SUPPORT");
$EnglishPlural->add_edge_by_id("arch", "component1", "RIGHT_VOUSSOIR");
...
$NdebeleCA->add_edge_by_id("elastic2", "MAXIMUM100-1", "MAXIMUM");
...
$NdebeleCA->add_edge_by_id("component4", "open2", "FILLEDNESS");
...
$NdebeleCA->add_edge_by_id("component3", "elastic2", "ELASTICITY");
$NdebeleCA->add_edge_by_id("component2", "null1", "FILLEDNESS");
$NdebeleCA->add_edge_by_id("component2", "stable2", "STABILITY");
$NdebeleCA->add_edge_by_id("component2", "inelastic1", "ELASTICITY");
...
$NdebeleCA->add_edge_by_id("arch", "component1", "RIGHT_SUPPORT");
$NdebeleCA->add_edge_by_id("arch", "component2", "LEFT_VOUSSOIR");
$NdebeleCA->add_edge_by_id("arch", "restkomponentenSet", "RESTKOMPONENTEN");
$NdebeleCA->add_edge_by_id("arch", "component4", "KEYSTONE");
$NdebeleCA->add_edge_by_id("arch", "component4", "KEYSTONE");
$NdebeleCA->add_edge_by_id("arch", "component5", "RIGHT_VOUSSOIR");
$NdebeleCA->add_edge_by_id("restkomponentenSet", "component3", "RESTKOMPONENT");
...
$TieneVerbSegments->add_edge_by_id("arch", "component1", "RIGHT_SUPPORT");
$TieneVerbSegments->add_edge_by_id("arch", "component3", "LEFT_VOUSSOIR");
$TieneVerbSegments->add_edge_by_id("arch", "component4", "LEFT_SUPPORT");
$TieneVerbSegments->add_edge_by_id("arch", "component4", "LEFT_SUPPORT");
$TieneVerbSegments->add_edge_by_id("arch", "component2", "RIGHT_VOUSSOIR");
$TieneVerbSegments->add_edge_by_id("component4", "open3", "FILLEDNESS");
...
$TieneVerbSegments->add_edge_by_id("component1", "unstable1", "STABILITY");
$TieneVerbSegments->add_edge_by_id("component1", "elastic2", "ELASTICITY");
$TieneVerbSegments->add_edge_by_id("component2", "open2", "FILLEDNESS");
$TieneVerbSegments->add_edge_by_id("component2", "unstable2", "STABILITY");
$TieneVerbSegments->add_edge_by_id("component2", "elastic1", "ELASTICITY");
$TieneVerbSegments->add_edge_by_id("component3", "null1", "FILLEDNESS");
$TieneVerbSegments->add_edge_by_id("component3", "stable1", "STABILITY");
$TieneVerbSegments->add_edge_by_id("component3", "inelastic1", "ELASTICITY");
$TieneVerbSegments->add_edge_by_id("unstable1", "component2", "ASSOCIATE");
$TieneVerbSegments->add_edge_by_id("unstable1", "left", "ASSOCIATE_POSITION");
$TieneVerbSegments->add_edge_by_id("inelastic1", "COUNT0-1", "COUNT");
$TieneVerbSegments->add_edge_by_id("inelastic2", "COUNT1-1", "COUNT");
$TieneVerbSegments->add_edge_by_id("unstable2", "right", "ASSOCIATE_POSITION");
$TieneVerbSegments->add_edge_by_id("unstable2", "component1", "ASSOCIATE");
...
$ChichewaAR->add_edge_by_id("component4", "filled2", "FILLEDNESS");
$ChichewaAR->add_edge_by_id("component4", "stable4", "STABILITY");
$ChichewaAR->add_edge_by_id("component4", "elastic2", "ELASTICITY");
...
$ChichewaAR->add_edge_by_id("component3", "inelastic2", "ELASTICITY");
$ChichewaAR->add_edge_by_id("component2", "null1", "FILLEDNESS");
$ChichewaAR->add_edge_by_id("component2", "stable2", "STABILITY");
$ChichewaAR->add_edge_by_id("component2", "inelastic1", "ELASTICITY");
$ChichewaAR->add_edge_by_id("filledComponentSet", "component1", "FILLED_COMPONENT");
$ChichewaAR->add_edge_by_id("filledComponentSet", "component4", "FILLED_COMPONENT");
...
$ChichewaAR->add_edge_by_id("inelastic1", "COUNT0-1", "COUNT");
$ChichewaAR->add_edge_by_id("inelastic2", "COUNT1-1", "COUNT");
...
$ChichewaAR->add_edge_by_id("arch", "component2", "LEFT_VOUSSOIR");
$ChichewaAR->add_edge_by_id("arch", "component3", "LEFT_SUPPORT");
$ChichewaAR->add_edge_by_id("arch", "component3", "LEFT_SUPPORT");
$ChichewaAR->add_edge_by_id("arch", "component4", "RIGHT_VOUSSOIR");
...
$EnglishVP->add_edge_by_id("component1", "elastic1", "ELASTICITY");
...
$EnglishVP->add_edge_by_id("component2", "null1", "FILLEDNESS");
$EnglishVP->add_edge_by_id("component2", "stable2", "STABILITY");
$EnglishVP->add_edge_by_id("component2", "inelastic1", "ELASTICITY");
$EnglishVP->add_edge_by_id("inelastic1", "COUNT0-1", "COUNT");
$EnglishVP->add_edge_by_id("inelastic2", "COUNT1-1", "COUNT");
$EnglishVP->add_edge_by_id("arch", "component1", "RIGHT_SUPPORT");
$EnglishVP->add_edge_by_id("arch", "component2", "LEFT_SUPPORT");
...
$GermanClause->add_edge_by_id("elastic3", "MAXIMUM1-1", "MAXIMUM");
...
$GermanClause->add_edge_by_id("component4", "unstable3", "STABILITY");
$GermanClause->add_edge_by_id("component4", "elastic2", "ELASTICITY");
$GermanClause->add_edge_by_id("component3", "open3", "FILLEDNESS");
$GermanClause->add_edge_by_id("component3", "unstable2", "STABILITY");
$GermanClause->add_edge_by_id("component3", "inelastic1", "ELASTICITY");
$GermanClause->add_edge_by_id("component2", "open2", "FILLEDNESS");
$GermanClause->add_edge_by_id("component2", "unstable1", "STABILITY");
$GermanClause->add_edge_by_id("component2", "elastic3", "ELASTICITY");
$GermanClause->add_edge_by_id("component1", "open1", "FILLEDNESS");
$GermanClause->add_edge_by_id("component1", "stable1", "STABILITY");
$GermanClause->add_edge_by_id("component1", "elastic1", "ELASTICITY");
$GermanClause->add_edge_by_id("unstable1", "component3", "ASSOCIATE");
$GermanClause->add_edge_by_id("unstable1", "right", "ASSOCIATE_POSITION");
$GermanClause->add_edge_by_id("inelastic1", "COUNT1-1", "COUNT");
$GermanClause->add_edge_by_id("unstable3", "component3", "ASSOCIATE");
...
$GermanClause->add_edge_by_id("unstable2", "component4", "ASSOCIATE");
$GermanClause->add_edge_by_id("arch", "component1", "RIGHT_SUPPORT");
$GermanClause->add_edge_by_id("arch", "component2", "LEFT_SUPPORT");
$GermanClause->add_edge_by_id("arch", "restkomponentenSet", "RESTKOMPONENTEN");
$GermanClause->add_edge_by_id("arch", "component2", "LEFT_SUPPORT");
$GermanClause->add_edge_by_id("arch", "component3", "KEYSTONE");
$GermanClause->add_edge_by_id("arch", "component5", "RIGHT_VOUSSOIR");
$GermanClause->add_edge_by_id("restkomponentenSet", "component4", "RESTKOMPONENT");
...
$BantuVCy->add_edge_by_id("component4", "elastic2", "ELASTICITY");
...
$BantuVCy->add_edge_by_id("component3", "open1", "FILLEDNESS");
$BantuVCy->add_edge_by_id("component3", "stable3", "STABILITY");
$BantuVCy->add_edge_by_id("component3", "inelastic2", "ELASTICITY");
...
$BantuVCy->add_edge_by_id("arch", "component3", "LEFT_SUPPORT");
$BantuVCy->add_edge_by_id("arch", "component3", "LEFT_SUPPORT");
$BantuVCy->add_edge_by_id("arch", "component4", "RIGHT_VOUSSOIR");
...
$NimboranVerb->add_edge_by_id("span", "component6", "LEFT_SUPPORT");
$NimboranVerb->add_edge_by_id("span", "component7", "RIGHT_SUPPORT");
$NimboranVerb->add_edge_by_id("component5", "open2", "FILLEDNESS");
$NimboranVerb->add_edge_by_id("component5", "stable4", "STABILITY");
$NimboranVerb->add_edge_by_id("component5", "elastic4", "ELASTICITY");
$NimboranVerb->add_edge_by_id("component4", "open1", "FILLEDNESS");
$NimboranVerb->add_edge_by_id("component4", "unstable1", "STABILITY");
$NimboranVerb->add_edge_by_id("component4", "inelastic1", "ELASTICITY");
...
$NimboranVerb->add_edge_by_id("unstable1", "component5", "ASSOCIATE");
...
$NimboranVerb->add_edge_by_id("restkomponentenSet", "component1", "RESTKOMPONENT");
...
$NimboranVerb->add_edge_by_id("open3", "incoherent1", "COHERENCE");
