...
$ChichewaAR->add_edge_by_id("arch", "component3", "LEFT_VOUSSOIR");
$ChichewaAR->add_edge_by_id("component3", "null1", "FILLEDNESS");
...
$BantuCT->add_edge_by_id("arch", "component3", "LEFT_VOUSSOIR");
...
$BantuCT->add_edge_by_id("component3", "null1", "FILLEDNESS");
...
$BantuCT->add_edge_by_id("component4", "open1", "FILLEDNESS");
...
$EnglishVP->add_edge_by_id("arch", "component2", "KEYSTONE");
$EnglishVP->add_edge_by_id("component2", "open1", "FILLEDNESS");
$EnglishVP->add_edge_by_id("open1", "coherent1", "COHERENCE");
$EnglishVP->add_edge_by_id("component2", "inelastic2", "ELASTICITY");
...
$EnglishVP->add_edge_by_id("arch", "component3", "RIGHT_VOUSSOIR");
$EnglishVP->add_edge_by_id("component3", "elastic1", "ELASTICITY");
...
$GermanClause->add_edge_by_id("arch", "component2", "RIGHT_VOUSSOIR");
$GermanClause->add_edge_by_id("component2", "elastic2", "ELASTICITY");
...
$GermanClause->add_edge_by_id("component2", "stable2", "STABILITY");
...
$GermanClause->add_edge_by_id("component3", "unstable1", "STABILITY");
$GermanClause->add_edge_by_id("unstable1", "component4", "ASSOCIATE");
$GermanClause->add_edge_by_id("component4", "open4", "FILLEDNESS");
$GermanClause->add_edge_by_id("open4", "incoherent4", "COHERENCE");
$GermanClause->add_edge_by_id("component4", "unstable2", "STABILITY");
...
$NimboranVerb->add_edge_by_id("component2", "open1", "FILLEDNESS");
...
$NimboranVerb->add_edge_by_id("component2", "unstable1", "STABILITY");
$NimboranVerb->add_edge_by_id("unstable1", "component3", "ASSOCIATE");
...
$MandeClause->add_edge_by_id("arch", "component3", "KEYSTONE");
$MandeClause->add_edge_by_id("component3", "inelastic1", "ELASTICITY");
...
$MandeClause->add_edge_by_id("arch", "component4", "LEFT_VOUSSOIR");
...
$ChintangPrefixes->add_edge_by_id("arch", "component1", "LEFT_VOUSSOIR");
$ChintangPrefixes->add_edge_by_id("component1", "inelastic1", "ELASTICITY");
$ChintangPrefixes->add_edge_by_id("inelastic1", "COUNT0-1", "COUNT");
$ChintangPrefixes->add_edge_by_id("component1", "null1", "FILLEDNESS");
$ChintangPrefixes->add_edge_by_id("component1", "stable1", "STABILITY");
$ChintangPrefixes->add_edge_by_id("arch", "component2", "LEFT_SUPPORT");
...
$ChintangPrefixes->add_edge_by_id("inelastic2", "COUNT1-1", "COUNT");
$ChintangPrefixes->add_edge_by_id("component2", "open1", "FILLEDNESS");
$ChintangPrefixes->add_edge_by_id("open1", "coherent1", "COHERENCE");
$ChintangPrefixes->add_edge_by_id("arch", "component2", "KEYSTONE");
...
$TieneVerbSegments->add_edge_by_id("component1", "elastic1", "ELASTICITY");
...
$TieneVerbSegments->add_edge_by_id("arch", "component3", "KEYSTONE");
...
$AghemClause->add_edge_by_id("arch", "component1", "LEFT_VOUSSOIR");
...
$AghemClause->add_edge_by_id("arch", "component3", "KEYSTONE");
...
$AghemClause->add_edge_by_id("component3", "inelastic1", "ELASTICITY");
...
$AghemClause->add_edge_by_id("unstable1", "component5", "ASSOCIATE");
...
$AghemClause->add_edge_by_id("restkomponentenSet", "component5", "RESTKOMPONENT");
...
$NdebeleCA->add_edge_by_id("arch", "component3", "RIGHT_VOUSSOIR");
...
$NdebeleCA->add_edge_by_id("component3", "filled1", "FILLEDNESS");
...
$NdebeleCA->add_edge_by_id("component4", "elastic3", "ELASTICITY");
$NdebeleCA->add_edge_by_id("elastic3", "MAXIMUM1-2", "MAXIMUM");
$NdebeleCA->add_edge_by_id("elastic3", "MINIMUM0-3", "MINIMUM");
$NdebeleCA->add_edge_by_id("component4", "filled2", "FILLEDNESS");
...
$NdebeleCA->add_edge_by_id("arch", "component5", "LEFT_VOUSSOIR");
$NdebeleCA->add_edge_by_id("component5", "inelastic2", "ELASTICITY");
$NdebeleCA->add_edge_by_id("inelastic2", "COUNT0-1", "COUNT");
$NdebeleCA->add_edge_by_id("component5", "null1", "FILLEDNESS");
...
$NdebeleCA->add_edge_by_id("filledComponentSet", "component3", "FILLED_COMPONENT");
