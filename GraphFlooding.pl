...
$GermanClause->add_edge_by_id("arch", "component3", "LEFT_SUPPORT");
...
$GermanClause->add_edge_by_id("elastic2", "MAXIMUM1-1", "MAXIMUM");
...
$GermanClause->add_edge_by_id("arch", "component3", "LEFT_VOUSSOIR");
...
$SerboCroatianJe->add_edge_by_id("span", "component1", "RIGHT_SUPPORT");
$SerboCroatianJe->add_edge_by_id("component1", "elastic1", "ELASTICITY");
...
$SerboCroatianJe->add_edge_by_id("component1", "open1", "FILLEDNESS");
$SerboCroatianJe->add_edge_by_id("open1", "incoherent1", "COHERENCE");
$SerboCroatianJe->add_edge_by_id("span", "component2", "LEFT_SUPPORT");
$SerboCroatianJe->add_edge_by_id("component2", "inelastic1", "ELASTICITY");
$SerboCroatianJe->add_edge_by_id("inelastic1", "COUNT1-1", "COUNT");
$SerboCroatianJe->add_edge_by_id("component2", "partiallyFilled1", "FILLEDNESS");
$SerboCroatianJe->add_edge_by_id("partiallyFilled1", "embeddedDesmeme", "FORM");
$SerboCroatianJe->add_edge_by_id("partiallyFilled1", "incoherent2", "COHERENCE");
...
$SerboCroatianJe->add_edge_by_id("filledComponentSet", "component2", "FILLED_COMPONENT");
...
$AghemClause->add_edge_by_id("arch", "component1", "RIGHT_VOUSSOIR");
$AghemClause->add_edge_by_id("component1", "open1", "FILLEDNESS");
$AghemClause->add_edge_by_id("open1", "coherent1", "COHERENCE");
$AghemClause->add_edge_by_id("component1", "unstable1", "STABILITY");
...
$AghemClause->add_edge_by_id("component2", "stable1", "STABILITY");
...
$AghemClause->add_edge_by_id("arch", "component3", "RIGHT_SUPPORT");
...
$AghemClause->add_edge_by_id("arch", "component4", "LEFT_VOUSSOIR");
$AghemClause->add_edge_by_id("component4", "stable3", "STABILITY");
$AghemClause->add_edge_by_id("component4", "elastic3", "ELASTICITY");
...
$TieneVerbSegments->add_edge_by_id("arch", "component1", "RIGHT_VOUSSOIR");
...
$TieneVerbSegments->add_edge_by_id("arch", "component2", "RIGHT_SUPPORT");
...
$ChichewaAR->add_edge_by_id("arch", "component2", "KEYSTONE");
...
$BantuCA->add_edge_by_id("component2", "filled1", "FILLEDNESS");
$BantuCA->add_edge_by_id("filled1", "canonicalLineate1", "FORM");
$BantuCA->add_edge_by_id("component2", "stable2", "STABILITY");
$BantuCA->add_edge_by_id("component2", "elastic1", "ELASTICITY");
...
$MeskwakiClause->add_edge_by_id("restkomponentenSet", "component2", "RESTKOMPONENT");
...
$MeskwakiClause->add_edge_by_id("component4", "open3", "FILLEDNESS");
...
$MeskwakiClause->add_edge_by_id("component3", "open4", "FILLEDNESS");
...
$NdebeleCA->add_edge_by_id("restkomponentenSet", "component4", "RESTKOMPONENT");
...
$NdebeleCA->add_edge_by_id("arch", "component2", "RIGHT_VOUSSOIR");
